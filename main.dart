...
} class _MyAppState extends State<MyApp>
{
    ...
    @override void initState()
    {
        ...
        location.enableBackgroundMode(enable
                                      : true);
    }
    @override
        Widget
            ...
            : Column(
                  ...
                  : [
                      ...
                      Expanded(child
                               : StreamBuilder(
                                   stream
                                   : FirebaseFirestore.instance.collection('location').snapshots(), builder
                                           ...
                                           : snapshot.data ?.docs.length,
                                             itemBuilder   : (context, index) {
                                                 return ListTile(
                                                       ...
                                                       : IconButton(
                                                             icon
                                                             : Icon(Icons.directions), onPressed
                                                             : () {
